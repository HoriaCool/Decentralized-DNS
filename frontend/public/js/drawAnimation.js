...
var w   = canvas_animation.width  = window.innerWidth,
	h   = canvas_animation.height = window.innerHeight,
	ctx = canvas_animation.getContext( '2d' ),
...
window.addEventListener( 'resize', function() {
	...
	opts.vanishPoint.x = ( w = canvas_animation.width  = window.innerWidth )  / 2;
	opts.vanishPoint.y = ( h = canvas_animation.height = window.innerHeight ) / 2;
	ctx.fillRect( 0, 0, w, h );
});
// window.addEventListener( 'click', init );
window.addEventListener( 'navigateNewRoute' , init );
